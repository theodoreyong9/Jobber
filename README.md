...
Site statique qui adapte un CV `.docx` à une offre d'emploi via
[Hugging Face Inference Providers](https://huggingface.co/docs/inference-providers)
(API compatible OpenAI), en gardant exactement la mise en page d'origine
(styles, polices, tableaux, photo) — seuls les textes de contenu (résumé,
descriptions de poste, compétences) sont reformulés.

⚠️ Le CV et le texte de l'annonce sont envoyés à Hugging Face (et à son
fournisseur d'inférence) pour la génération — ce n'est pas un traitement
100% local.
...
- La disponibilité et la vitesse dépendent du fournisseur d'inférence
  choisi et de ton quota/compte Hugging Face.
