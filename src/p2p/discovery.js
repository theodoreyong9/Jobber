...
export class RoomRanker {
  ...
  ingestBroadcast(peerId, broadcast) {
    ...
    this.scores.set(identityKey, {
      ...score,
      identityKey, // identite applicative du diffuseur (survit aux reconnexions/rotation de transport)
      ...
      lat: typeof broadcast.lat === 'number' ? broadcast.lat : null,
      lng: typeof broadcast.lng === 'number' ? broadcast.lng : null,
